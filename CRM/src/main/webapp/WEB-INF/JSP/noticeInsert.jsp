...
<body>
        ...
        <div class="box4">
            ...
            <div class="box5"><span style="margin: 30px 0 0 50px";>发布公告</span></div>
                ...
                <table border="1" class="tablebox">
                    ...
                    <tr>
                            <td class="td">
                                ...
                                <td>
                                    <input type="text" name="subject" placeholder="请填写公告主题">
                                </td>
                                <td class="td">通知范围</td>
                                <td>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <div class="box7">
							<input type="text" name="text" placeholder="请填写公告内容">
                            </div>
                        </td>
                    </tr>
                </table>
