...
<body>
            ...
            <div class="box3">
                <div class="box4">
                    <div class="box5"><span style="margin: 30px 0 0 50px";>更新角色</span></div>
                   
        			<form action="roleUpdate" method="post">
        			<input type="hidden" name="role.role_id" value="${role2.role_id}">
                    <div style="margin: 0 0 0 50px">
                        <table border="1" class="table">
                            <tr>
                               
                                <td style="text-align: center;line-height:40px;"><strong>角色名称</strong></td>
                                <td><input type="text" name="role_name" value="${role2.role_name}" placeholder="填写角色名称">
                            ...
                            <tr>
                                ...
                                <td>
                                   	<input type="text" name="remark" value="${role2.remark}" placeholder="请填写角色描述">
                    ...
                    <div class="box8">
                            <div class="box9">
                             ...
                             <button type="submit" class="btn btn-primary">保存</button>
               				 <a href="roleSelect"><button type="button" class="btn btn-default">返回</button></a>
                             </div>
