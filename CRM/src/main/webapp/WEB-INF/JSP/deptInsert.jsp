...
<body>
            ...
            <div class="box3">
                <div class="box4">
                    <div class="box5"><span style="margin: 30px 0 0 50px";>添加部门</span></div>
                    ...
                    <div style="margin: 0 0 0 50px">
                        <table border="1" class="table">
                            ...
                            <tr>
                                <td style="height:300px;text-align: center;line-height:200px;"><strong>部门描述</strong></td>
                                <td>
                                   	<input type="text" name="department_desc" placeholder="请填写部门描述">
