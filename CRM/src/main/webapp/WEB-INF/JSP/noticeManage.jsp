...
<body>
    ...
    <div class="box3">
          	...
          	<br>
          	 <div style="margin: 0 0 0 50px">
                <table border="1" class="table">
                	...
                	<s:iterator var="notice2" value="pageBean.list">
                   <tr>
		...
		<s:else> 
		<a href="noticeSelect?page=1"><button type="button" class="btn btn-default">第一页</button></a> 
		<a href="noticeSelect?page=<s:property value="%{pageBean.currentPage-1}"/>"><button type="button" class="btn btn-default">上一页</button></a> 
		</s:else> 
		<s:if test="%{pageBean.currentPage != pageBean.totalPage}"> 
		<a href="noticeSelect?page=<s:property value="%{pageBean.currentPage+1}"/>"><button type="button" class="btn btn-default">下一页</button></a> 
		<a href="noticeSelect?page=<s:property value="pageBean.totalPage"/>"><button type="button" class="btn btn-default">最后一页</button></a> 
		</s:if> 
		<s:else> 
